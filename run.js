...
miscale.on('data', function (scale) {
  if (scale.isStabilized && !scale.loadRemoved) {
    ...
    var txt = 'Detected ' + scale.weight + 'kg';
    console.log(txt);

    request.post(
      'https://hooks.slack.com/services/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',
      { json: { channel: '#tmp', username: 'Weight', icon_url: 'https://cdn2.iconfinder.com/data/icons/electronics-solid-icons-vol-2/48/084-512.png', text: txt} },
